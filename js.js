...
function draw() {
    ...
    if (ballx < paddel1X + 10 && ballx + 20 > paddel1X && bally + 20 > paddel1Y && bally < paddel1Y + 100) {
        ballx = 20;
    ...
    if (ballx < paddel2X + 10 && ballx + 20 > paddel2X && bally + 20 > paddel2Y && bally < paddel2Y + 100) {
        ballx = 760;
        ballxspeed = -ballxspeed;
        firstHit++;
        ballxspeed = ballxspeed * 1.1;
